function [TV,TF,TN,B,VV,VE,VRP,VRD] = triangle_top(varargin)
  % TRIANGLE_TOP interface to the Triangle Program.
  ...
  %   B   #TV by 1 list of bits indicating whether vertices are on the
  %   boundary
  ...
  [TV,I,B] = readNODE_top([prefix '.1.node']);
